...
l0 = load_0 * (1+0.2*unifrnd(-1,1,1,1)); %base: (2383,0.2) (39, 118:1)
upper_gen = 100; %39, 500,300,2383:100, 118:50
% l0 = load_0 * 1; %39:1, 300, 500: 1.2, 118:0.8, 2383:0.2
...
optimize(C_ori_pre,J_ori_pre,ops);
...
filename_csv="linear_data_all500_GE_validation.csv";
