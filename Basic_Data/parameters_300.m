function [num_of_gen, num_buses, num_of_lines, a_ln, load_0, b, c, coe, num_of_rand,line_flow_limit] = parameters_300
...
num_of_lines = 411;
num_of_rand = 300;
coe = [1;2;0.5;0.8;3;10;1;1.5;2;4;1.9;1.5;2.5;0.9;1.4;5;2.8;0.4;0.1;0.6;1.3;2.1;0.7;0.9;0.8;10;1;1.5;2;4;2.3;1.1;1.3;1.2;0.9;4;1.4;1.2;2.1;3.4;1.1;0.6;0.8;0.7;1.4;0.2;0.8;0.5;3.2;4.1;1.2;1.5;2.1;4.3;1;2;0.5;0.8;3;10;1;1.5;2;4;1.9;1.5;2.5;0.9;1.4];

a_ln = csvread('PTDF300.csv');
g_index = csvread('GEN300.csv');
r_index = csvread('RAND300.csv');
load_0 = csvread('load_300.csv');
load_0 = load_0 * 0.02
